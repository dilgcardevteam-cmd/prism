...
return new class extends Migration
{
    ...
    {
        Schema::create('tblmonitoring_evaluation_monthly_documents', function (Blueprint $table) {
            $table->id();
            $table->string('office');
            ...
            $table->unique(
                ...
                'tblmonitoring_evaluation_monthly_documents_unique'
            );
        });
    }
    ...
    {
        Schema::dropIfExists('tblmonitoring_evaluation_monthly_documents');
    }
};
