...
return new class extends Migration
{
    ...
    {
        Schema::create('tblpd_no_pbbm_2025_1572_1573_documents', function (Blueprint $table) {
            $table->id();
            $table->string('office');
            ...
            $table->unique(
                ...
                'tblpd_no_pbbm_2025_1572_1573_documents_unique'
            );
        });
    }
    ...
    {
        Schema::dropIfExists('tblpd_no_pbbm_2025_1572_1573_documents');
    }
};
