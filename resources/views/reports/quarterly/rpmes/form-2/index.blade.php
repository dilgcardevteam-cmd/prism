...
@section('content')
    ...
    <div style="background: white; padding: 16px 20px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08); margin-bottom: 20px; border: 1px solid #e5e7eb; display: flex; justify-content: space-between; align-items: center; gap: 12px; flex-wrap: wrap;">
        <div>
            <div style="font-size: 15px; font-weight: 700; color: #111827;">SubayBayan Project List</div>
            <div style="font-size: 13px; color: #6b7280; margin-top: 4px;">All accessible SubayBayan projects are listed below, ordered by latest funding year first.</div>
        </div>
                ...
                <tbody>
                    @forelse ($projects as $index => $project)
                        ...
                        <tr style="background-color: {{ $rowBg }}; border-bottom: 1px solid #e5e7eb; transition: background-color 0.15s;"
                            ...
                            <td style="padding: 14px 16px; text-align: center; white-space: nowrap;">
                                <a href="{{ route('reports.quarterly.rpmes.form-2.show', ['projectCode' => $project->project_code]) }}" style="display: inline-flex; align-items: center; gap: 6px; padding: 7px 14px; background-color: #002C76; color: white; text-decoration: none; border-radius: 6px; font-size: 12px; font-weight: 600; transition: background-color 0.2s;"
        ...
        @if($projects->count() > 0)
            <div style="padding: 16px 20px; border-top: 1px solid #e5e7eb; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
                <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                    ...
                    <form method="GET" action="{{ route('reports.quarterly.rpmes.form-2') }}" style="display: inline-flex; align-items: center;">
