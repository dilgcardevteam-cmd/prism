...
@section('content')
    ...
    <div class="content-header">
        ...
        <p>Quarterly uploading workspace for monitoring contractor compliance to inform the public before commencement of road projects.</p>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div style="display:flex;align-items:flex-start;gap:14px;padding:20px;border:1px solid #dbe3ee;border-radius:14px;background:linear-gradient(180deg,#ffffff 0%,#f8fbff 100%);margin-bottom:20px;">
                        ...
                        <div>
                            <div style="font-size:18px;font-weight:700;color:#111827;margin-bottom:6px;">Quarterly Compliance Monitoring</div>
                            <p style="margin:0;color:#4b5563;font-size:14px;line-height:1.7;">
                                Open an LGU workspace below to upload or review the quarterly PDF submission and encoding template required under
                                <strong>DILG MC No. 2018-30</strong>.
                            </p>
                        </div>
                    </div>
                    ...
                    <div style="background:#ffffff;padding:16px 20px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,.08);margin-bottom:20px;border:1px solid #e5e7eb;">
                        <form method="GET" action="{{ route('reports.quarterly.dilg-mc-2018-30') }}" style="display:flex;flex-wrap:wrap;gap:10px;align-items:flex-end;">
                            ...
                            <div style="flex:1 1 180px;min-width:180px;">
                                ...
                                <select id="dilg-mc-2018-30-province" name="province" style="width:100%;height:42px;padding:0 10px;border:1px solid #d1d5db;border-radius:8px;font-size:13px;background:#f9fafb;color:#374151;">
                            ...
                            <div style="flex:1 1 220px;min-width:220px;">
                                ...
                                <select id="dilg-mc-2018-30-city" name="city" data-selected-city="{{ $activeFilters['city'] }}" style="width:100%;height:42px;padding:0 10px;border:1px solid #d1d5db;border-radius:8px;font-size:13px;background:#f9fafb;color:#374151;">
                            ...
                            <a href="{{ route('reports.quarterly.dilg-mc-2018-30', ['year' => $reportingYear, 'per_page' => $perPage ?? 15]) }}"
                    ...
                    <div class="report-table-shell" data-freeze-columns data-freeze-columns-max="3" data-freeze-columns-key="dilg-mc-2018-30-index" style="background:#fff;padding:24px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,.1);overflow-x:auto;">
                            ...
                            <tbody>
                                @forelse ($officeRows as $row)
                                    ...
                                    <tr style="border-bottom:1px solid #e5e7eb;">
                                        ...
                                        <td style="padding:12px;text-align:center;">
                                            <a href="{{ route('reports.quarterly.dilg-mc-2018-30.show', ['office' => $row['city_municipality'], 'year' => $reportingYear]) }}"
    ...
    <script>
        (function () {
            const provinceSelect = document.getElementById('dilg-mc-2018-30-province');
            const citySelect = document.getElementById('dilg-mc-2018-30-city');
