    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div style="background: #ffffff; padding: 16px 20px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08); margin-bottom: 20px; border: 1px solid #e5e7eb;">
                    <form id="me-monthly-filters-form" method="GET" action="{{ route('reports.dilg-deliverables.monitoring-evaluation') }}" style="display: flex; flex-wrap: wrap; gap: 10px; align-items: flex-end;">
                        ...
                        <div style="flex: 0 0 120px; min-width: 120px;">
                            ...
                            <select id="me-monthly-year" name="year" style="width: 100%; height: 42px; padding: 0 10px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 13px; background-color: #f9fafb; color: #374151;">
                        ...
                        <div style="flex: 1 1 180px; min-width: 180px;">
                            <label for="me-monthly-filter-province" style="display: block; margin-bottom: 6px; color: #374151; font-size: 12px; font-weight: 600;">Province</label>
                            <select id="me-monthly-filter-province" name="province" style="width: 100%; height: 42px; padding: 0 10px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 13px; background-color: #f9fafb; color: #374151;">
                ...
                <div class="table-responsive report-table-shell" data-freeze-columns data-freeze-columns-max="2" data-freeze-columns-key="me-monthly-index" style="background: white; padding: 30px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
                    <table id="me-monthly-table" style="width: 100%; border-collapse: collapse; min-width: 1400px;">
                        <thead>
                            <tr style="background-color: #f3f4f6; border-bottom: 2px solid #e5e7eb;">
                                <th style="padding: 12px; text-align: left; color: #374151; font-weight: 600; font-size: 14px; white-space: nowrap;">Province / Office</th>
                        ...
                        <tbody id="me-monthly-table-body">
                            ...
                            @empty
                                <tr style="border-bottom: 1px solid #e5e7eb;">
                                    <td colspan="{{ count($months) + 2 }}" style="padding: 40px; text-align: center; color: #6b7280;">
...
<style>
    #me-monthly-table-body tr:hover {
