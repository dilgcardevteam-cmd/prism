...
@section('title', 'SGLGIF Project Table')
@section('page-title', 'SGLGIF Project Table')
...
@section('content')
    @php
        ...
        $sortUrl = function (string $column, string $defaultDirection = 'asc') use ($nextSortDirection) {
            ...
            return route('projects.sglgif.table', $query);
        };
    ...
    <div class="content-header">
        <h1>SGLGIF Project Table</h1>
        <p>
            Standalone table sourced from the imported SGLGIF database.
            @if($latestUpdateAt)
    ...
    <div class="sglgif-table-page">
        <section class="sglgif-shell-card sglgif-shell-card--hero">
            <div class="sglgif-shell-copy">
                <h2>Imported SGLGIF Records</h2>
                <p>{{ number_format((int) ($totalProjects ?? 0)) }} project rows in the current SGLGIF scope.</p>
            </div>
            <div class="sglgif-shell-actions">
                <a href="{{ route('projects.sglgif', request()->query()) }}" class="sglgif-action-btn sglgif-action-btn--accent">
        ...
        <form method="GET" action="{{ route('projects.sglgif.table') }}" class="sglgif-shell-card sglgif-filter-card">
            ...
            <div class="sglgif-filter-grid">
                ...
                <div class="sglgif-filter-field">
                    <label for="sglgif-per-page">Rows</label>
                    <select id="sglgif-per-page" name="per_page">
            ...
            <div class="sglgif-filter-actions">
                ...
                <a href="{{ route('projects.sglgif.table') }}" class="sglgif-action-btn sglgif-action-btn--muted">
        ...
        <section class="sglgif-shell-card sglgif-table-card">
            @if($projects->isEmpty())
                <div class="sglgif-empty-state">
                    ...
                    <strong>No SGLGIF records found.</strong>
                    ...
                    <table class="sglgif-table sglgif-table--full">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <a href="{{ $sortUrl('updated_at', 'desc') }}" class="sglgif-sort-link">
                                        <span>Last Updated</span>
                                        <span class="sglgif-sort-indicator">{{ $sortIndicator('updated_at') }}</span>
                                    </a>
                                </th>
                            </tr>
                        </thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($updatedAt)
                                            ...
                                            <div class="sglgif-subline">{{ $updatedAt->format('h:i A') }}</div>
                                        @else
                                            -
                                        @endif
                                    </td>
